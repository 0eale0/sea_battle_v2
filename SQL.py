import sqlite3
import json  # надо добавить импорт доски и счетчик номер игры


class SaveGame:
    def __init__(self, number_game):
        ...
        # создает столбцы для таблички где player1, player2 и one_or_zero название стобцов

    def __add__(self, field_player1, field_player2, one_or_zero):
    ...
    def save(self):
        self.con.commit()  # сохраняет таблицу
